                ...
                <BrowserRouter basename="/event">
                    <Routes>
                        ...
                        <Route path="/admin/event/:slug" element={<EventAdminLayout />}>
                            ...
                            {/* Pages Management (card list) - entry into editor */}
                            <Route path="pages" element={<PageManagement />} />
                            {/* Visual Editor for a specific page, keyed by pageKey */}
                            <Route path="editor/:pageKey" element={<EventEditor />} />
                            {/* Legacy: redirect old /editor to /pages */}
