...
function App() {
    ...
    const markerPositionIOD = [
        ...
        { position: [7.539989, -5.54708], name: "Yuniwati	", email: "yuniwati@icbp.indofood.co.id	", country: "CÃ´te d'Ivoire" },
    ...
    const markerPositions2 = [
        ...
        { position: [0.18636, 6.613081], name: "Indofood International	", email: "International@icbp.indofood.co.id	", country: "SÃ£o TomÃ© and PrÃ­ncipe" },
