...
import { apiDelete, apiGet, apiPost } from "../../../../services/api/http";
...
function Itemconfig() {
    ...
    const onSubmit = async () => {
        ...
        if (image === '') {
            ...
            try {
                const response = await apiPost("/admin/banner", userToken, data);
    ...
    const deleteData = async (id) => {
        let userToken = localStorage.getItem("tokek");
        try {
            await apiDelete("/admin/banner/", userToken, { data: { id: id } });
            getItemData();
            onCloseDeleteBanner();
            handleRefresh();
        } catch (error) {
    ...
    const getItemData = async () => {
        let userToken = localStorage.getItem("tokek");
        await apiGet("/admin/banner", userToken)
            .then((res) => {
