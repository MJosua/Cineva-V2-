...
import { getSubmissionsByEvent, getSubmissionStats, getPoolsByEvent, getPoolStats, getDailySubmissionStats, getWinnersByCampaign } from "../../services/eventEngineApi";
        ...
        <Box p={6}>
            ...
            <SimpleGrid columns={{ base: 2, md: 4 }} spacing={4} mb={8}>
                <Stat bg="white" p={4} borderRadius="lg" shadow="sm">
                    ...
                    <StatNumber color="purple.600">{subStats.total}</StatNumber>
                    <StatHelpText>
