...
export default function SettingsPage() {
    ...
    const [settings, setSettings] = useState({
        name: event?.blocks?.find(b => b.type === "hero")?.props?.title || "",
        slug: slug,
                                ...
                                <VStack spacing={4} align="stretch">
                                    <FormControl>
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => setSettings(prev => ({ ...prev, themeBackground: e.target.value }))}
                                        />
                                        <Box
                                            mt={2}
                                            h="60px"
                                            borderRadius="md"
                                            bg={settings.themeBackground}
                                        />
                                    </FormControl>
                                    ...
                                    <FormControl>
                                        <FormLabel>Text Color (for Blocks)</FormLabel>
                                        <HStack>
                                            <Input
                                                type="color"
                                                w="100px"
                                    ...
                                    <Alert status="info">
                                        <AlertIcon />
                                        Use the Page Builder for more detailed visual customization
                                    </Alert>
                                </VStack>
                            </fieldset>
                        </Box>
