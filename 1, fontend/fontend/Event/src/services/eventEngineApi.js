...
const API_BASE = import.meta.env.VITE_API_BASE || '/api/event-engine';
...
async function apiFetch(endpoint, options = {}) {
    ...
    // 🔥 FIX: Inject Authorization Header from LocalStorage
    // The AuthContext saves user data (including token) to "event_admin"
    let authHeader = {};
    try {
