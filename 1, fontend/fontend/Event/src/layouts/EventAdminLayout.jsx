...
const SIDEBAR_ITEMS = [
    ...
    { label: "Page Editor", path: "editor", icon: MdWeb },
...
export default function EventAdminLayout() {
    ...
    const activeBg = useColorModeValue("purple.600", "purple.600");
    ...
    const sidebarItemsFiltered = SIDEBAR_ITEMS.filter(item => {
        ...
        if (isAdmin) {
            // Admin: Hide Editor and Settings
            return item.path !== 'editor' && item.path !== 'settings';
        }
        return false;
    });
            ...
            <Box w="240px" bg={sidebarBg} color="white" p={4} display="flex" flexDirection="column">
                ...
                <VStack align="start" spacing={1} mb={4}>
                    ...
                    <Text fontWeight="bold" fontSize="lg" noOfLines={1}>
                        {currentEvent.blocks?.find(b => b.type === "hero")?.props?.title || currentEvent.slug}
                    </Text>
