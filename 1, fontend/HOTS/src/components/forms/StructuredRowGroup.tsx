    ...
    <div className="space-y-4">
      <Card>
        ...
        <CardContent className="space-y-4 pt-4">
          {rows.map((r) => (
            <div key={r.id} className="grid grid-cols-1 md:grid-cols-6 gap-3 md:gap-4 mb-4 md:mb-0 border-b border-gray-100 md:border-b-0 pb-4 md:pb-0">
              ...
              <div className="col-span-1 md:col-span-2 flex items-center gap-2 w-full">
                ...
                {rows.length > 1 && (
                  <Button variant="outline" size="sm" onClick={() => removeRow(r.id)} className="h-[38px] shrink-0 hover:bg-red-50 hover:text-red-500">
                    <Trash2 size={16} />
                  </Button>
                )}
              </div>
