...
import { mapUnifiedForm, getMaxFormFields, convertUnifiedToEngineEav, mapFormDataToTicketColumns } from "@/utils/formFieldMapping";
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <WarningDialog
        ...
        confirmLabel="Yes"
        cancelLabel="Cancel"
        onConfirm={handleSubmitEngineCore}
