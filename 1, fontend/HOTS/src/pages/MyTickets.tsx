      ...
      <Card className="border-border shadow-sm">
        <CardContent className="p-4">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:flex lg:items-center gap-4 w-full md:w-auto">
              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                <Label htmlFor="status-filter" className="text-muted-foreground whitespace-nowrap">Status:</Label>
                <Select value={filterStatus} onValueChange={setFilterStatus}>
                  <SelectTrigger className="w-full md:w-40 border-input">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                <Label htmlFor="priority-filter" className="text-muted-foreground whitespace-nowrap">Priority:</Label>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:col-span-2 lg:col-span-1">
                <Label htmlFor="type-filter" className="text-muted-foreground whitespace-nowrap">Type:</Label>
            ...
            <div className="flex items-center justify-end space-x-2 pt-2 md:pt-0 border-t md:border-t-0 border-border">
              <Button
