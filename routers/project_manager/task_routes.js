...
// Task CRUD operations - Fixed route order (most specific routes first)
...
route.get('/:id', decodeTokenHT, task_controller.getTaskById);
route.get('/', decodeTokenHT, task_controller.getAllTasks);
route.post('/', decodeTokenHT, task_controller.createTask);
route.put('/:id', decodeTokenHT, task_controller.updateTask);
...
// Delete task
route.delete('/:id', decodeTokenHT, task_controller.deleteTask);
