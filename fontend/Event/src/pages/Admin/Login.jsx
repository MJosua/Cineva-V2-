...
export default function AdminLogin() {
    ...
    return (
        <Box h="100vh" bgGradient="linear(to-br, purple.900, purple.500)" display="flex" alignItems="center">
            <Container bg="white" p={8} borderRadius="xl" boxShadow="2xl" maxW="sm">
                <VStack spacing={6}>
                    <Heading size="lg" color="purple.800">🎉 Event Admin</Heading>
                    ...
                    <Text fontSize="xs" color="gray.400">
                        Demo: super@example.com / admin123
                    </Text>
                </VStack>
            </Container>
        </Box>
