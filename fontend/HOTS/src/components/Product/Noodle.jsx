                    ...
                    <div className="row">
                        ...
                        <div className="col-8 pe-5 text-start responsive-isi">
                            ...
                            <div className=" border-bottom pb-5 border-danger">
                                ...
                                Sarimi is another product of Indofood that has long been providing delights for the Indonesian palate. Known for its’ bold taste and strong aroma, loved by everyone.
