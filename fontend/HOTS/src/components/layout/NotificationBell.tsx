...
const NotificationBell: React.FC = () => {
    ...
    const handleNotificationClick = (notification: Notification) => {
        ...
        if (notification.data_payload?.url) {
            setIsOpen(false);
            navigate(notification.data_payload.url);
        }
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-xs text-muted-foreground mt-0.5 line-clamp-2">
                                                {/* 🆕 Prefer rich payload message over DB message */}
                                                {(notification.data_payload as any)?.message || notification.message}
                                            </p>
                                        </div>
