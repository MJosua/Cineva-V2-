...
function AddMoreContainerHeader({
    ...
    const { company_name, company_id, user, spc_condition } = useSelector((state) => {
        return {
                    ...
                    switch (key) {
                        case "Destination Port:": {
                            ...
                            const match = portMap.find(p => {
                                ...
                                console.log("Checking harbour_code:", p.harbour_code, "Suffix:", suffix, "Prefix:", portPrefix);
                                return suffix === portPrefix;
                            });

                            if (match) {
                                console.log("Matched harbour_code:", match.harbour_code, "Harbour ID:", match.id);
