                                        ...
                                        <Accordion allowToggle className="text-secondary">
                                            ...
                                            <AccordionItem className="card border_radius_10px px-1 py-1 shadow-sm">
                                                ...
                                                <AccordionPanel pb={4} className="text-start">
                                                    Based on the terms and conditions and the Customer Shipment Instructions (CSI) that we have agreed upon, your order will be shipped 5 weeks after the week in which you submit the order.
                                                </AccordionPanel>
                                            </AccordionItem>
                                            ...
                                            <AccordionItem className="card border_radius_10px px-1 py-1 mt-3 shadow-sm">
                                                ...
                                                <AccordionPanel pb={4} className="text-start">
                                                    ...
                                                    •	If the status is <b>"waiting for confirmation",</b> modifications or cancellations are possible.<br></br>
                                                    •	If the status is already <b>"confirmed"</b>, modifications or cancellations may be possible, but you must contact our support team in your region.<br></br>
                                                    •	If the status is already <b>"on process"</b>, modifications or cancellations are not possible.
                                                </AccordionPanel>
                                            </AccordionItem>
                                        ...
                                        <Accordion allowToggle className="text-secondary">
                                            ...
                                            <AccordionItem className="card border_radius_10px px-1 py-1 shadow-sm">
                                                ...
                                                <AccordionPanel pb={4} className="text-start">
                                                    ...
                                                    <br></br>
                                                    •	Shipping Document and Bill of Loading (BL)
                                                    <br></br>
                                                    •	Close-up photos before and after the container seal is broken.
                                                    <br></br>
                                                    •	Photo of closed container doors.
                                                    <br></br>
                                                    •	Photo of partially open container doors (open on the left door).
                                                    <br></br>
                                                    •	Last photo of tier before unloading.
                                                    <br></br>
                                                    •	Complete documents for unloading product (scan/photo)
                                                    <br></br>
                                                    •	Detail photo damage/wrong products (including batch code, exp date, production date).
                                                    <br></br>
                                                    •	Video documentation of unloading process.
