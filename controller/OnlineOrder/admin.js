    ...
    if (req.dataToken.type_id = 9) {
      ...
      if (uidAlreadyExist == 0 && user_idAlreadyExist == 0) {
        ...
        dbConf.query(
          ...
          (err, results) => {
            ...
            if (err) {
              ...
              log.eorder.error("Error query SQL :", err);
              ...
              log.eorder.info(`Admin create account ${userID} success`);
            }
          }
        );
        ...
        if (user_idAlreadyExist > 0 && uidAlreadyExist > 0) {
          ...
          log.eorder.info(`user_id ${userID} and uid '${uid}' already exist. Please try another user_id and uid`)
          ...
          if (uidAlreadyExist > 0) {
            ...
            log.eorder.info(`uid ${uid} already exist. Please try another user_id `)
            ...
            if (user_idAlreadyExist > 0) {
              ...
              log.eorder.info(`user_id ${userID} already exist. Please try another user_id`)
      ...
      log.eorder.warn("!!!_UNAUTHORIZED_!!! Admin Create Account by : " + req.dataToken.uid);
    }
    ...
    if (req.dataToken.type_id = 9) {
      ...
      dbConf.query(query, (err, results) => {
        ...
        if (err) {
          ...
          log.eorder.info(`Admin Edit Account Data ${userID} success`);
        }
      }
      );
      ...
      log.eorder.warn("!!!_UNAUTHORIZED_!!! Admin Edit Account by : " + req.dataToken.uid);
    }
      ...
      if (req.dataToken.type_id = 9) {
        dbConf.query(
          ...
          (err, results) => {
            if (err) {
              res.status(500).send(err);
              log.eorder.error("XXX Failed => Admin Get User Account by : " + req.dataToken.uid)
            } else {
              res.status(200).send({
                message: 'berhasil query data',
                results
              });
              log.eorder.info("Admin Get User Account by : " + req.dataToken.uid + " success")
            }
          })
        ...
        log.eorder.warn("!!!_UNAUTHORIZED_!!! Admin Get User Account by : " + req.dataToken.uid);
      }
    } catch (error) {
      log.eorder.error("Error in getAccount:", error);
...
WHERE
	...
	AND su.user_id = ${req.body.user_id};`
        ...
        (err, results) => {
          if (err) {
            ...
            log.eorder.error("XXX Failed => Admin Get Account Detail by : " + req.dataToken.uid + '->' + err)
          } else {
            res.status(200).send({
              message: 'berhasil query data',
              success: true,
            ...
            log.eorder.info("Admin Get Account Detail by : " + req.dataToken.uid + " success")
          }
        })
  ...
  changeActive: async (req, res) => {
    if (req.dataToken.type_id = 9) {
      ...
      dbConf.query(
        ...
        (err, results) => {
          if (err) {
            ...
            log.eorder.error("XXX Failed => Admin Patch Active by : " + req.dataToken.uid + err)
            ...
            log.eorder.info(`Admin Active for ${username} by: ${req.dataToken.uid} success`)
          }
        })
      ...
      log.eorder.warn("!!!_UNAUTHORIZED_!!! Admin Patch Active by : " + req.dataToken.uid);
    }
    ...
    if (req.dataToken.type_id = 9) {
      ...
      ORDER BY
        ...
        if (err) {
          ...
          log.eorder.error("XXXX FAILURE Admin Get Config by : " + req.dataToken.uid + ' fail:' + err)
          ...
          log.eorder.info("Admin Get Config by : " + req.dataToken.uid)
        }
      }
      )
    } else {
      ...
      log.eorder.warn("!!!_Unauthorized_!!! Admin Get Config by : " + req.dataToken.uid + ' fail')
    }
  },
    ...
    if (req.dataToken.type_id = 9) {
      ...
      dbConf.query(query, (err, results) => {
        ...
        if (err) {
          ...
          log.eorder.error("XXXX FAILURE Admin add Config by : " + req.dataToken.uid + ' fail:' + err)
          ...
          log.eorder.info("Admin addConfig by : " + req.dataToken.uid + ' success')
        }
      }
      )
    } else {
      ...
      log.eorder.warn("!!!_Unauthorized_!!! Admin add Config by : " + req.dataToken.uid)
    }
  },
    ...
    if (req.dataToken.type_id = 9) {
      ...
      dbConf.query(query, (err, results) => {
        ...
        if (err) {
          ...
          log.eorder.error("XXXX FAILURE edit Get Config by : " + req.dataToken.uid + ' fail:' + err)
          ...
          log.eorder.info("Admin edit Config by : " + req.dataToken.uid + ' success')
        }
      })
    } else {
    ...
    if (req.dataToken.type_id = 9) {
      ...
      dbConf.query(query, (err, results) => {
        ...
        if (err) {
          ...
          log.eorder.error("XXXX FAILURE Admin add banner by : " + req.dataToken.uid + ' fail:' + err)
          ...
          log.eorder.info("Admin add banner by : " + req.dataToken.uid + ' success');
        }
      }
      )
    } else {
  ...
  getBanner: async (req, res) => {
    ...
    ORDER BY
      ...
      dbConf.query(query
        , (err, results) => {
          ...
          if (err) {
            ...
            log.eorder.error("XXXX FAILURE Admin Get Banner by : " + req.dataToken.uid + ' fail:' + err)
            ...
            log.eorder.info("Admin Get Banner by : " + req.dataToken.uid + ' success')
          }
        }
      )
    } else {
      ...
      log.eorder.warn("!!!_Unauthorized_!!! Admin Get banner by : " + req.dataToken.uid)
    }
  },
    ...
    if (req.dataToken.type_id = 9) {
      ...
      dbConf.query(query, (err, results) => {
        ...
        if (err) {
          ...
          log.eorder.error("XXXX FAILURE Admin Delete Banner by : " + req.dataToken.uid + ' Message:' + err)
          ...
          addSqlLogger(req.dataToken.user_id, query, (JSON.stringify(results)), 'addBanner');
          log.eorder.info("Admin Delete Banner by : " + req.dataToken.uid + ' success')
        }
      })
      ...
      log.eorder.warn("!!!_Unauthorized_!!! Admin Delete Banner by : " + req.dataToken.uid)
    }
  },
  getFeedback: async (req, res) => {
    if (req.dataToken.type_id = 9) {
      ...
      dbConf.query(
        ...
        , (err, results) => {
          ...
          if (err) {
            ...
            log.eorder.error("XXXX FAILURE Admin Get Feedback by : " + req.dataToken.uid + ' fail:' + err)
            ...
            log.eorder.info("Admin Get Feedback by : " + req.dataToken.uid + ' success')
          }
        }
      )
    } else {
      ...
      log.eorder.warn("!!!_Unauthorized_!!! Admin Get Feedback by : " + req.dataToken.uid + ' fail')
    }
  },
  getRequestDataChange: async (req, res) => {
    if (req.dataToken.type_id = 9) {
      ...
      dbConf.query(
        ...
        , (err, results) => {
          ...
          if (err) {
            ...
            log.eorder.error("XXXX FAILURE Admin Get Request Data Change by : " + req.dataToken.uid + ' fail:' + err)
            ...
            log.eorder.info("Admin Get Request Data Change by : " + req.dataToken.uid + ' success')
          }
        }
      )
    } else {
      ...
      log.eorder.warn("!!!_Unauthorized_!!! Admin Get Request Data Change by : " + req.dataToken.uid)
    }
  },
    ...
    if (req.dataToken.uid) {
      ...
      dbConf.query(query, (err, results) => {
        ...
        if (err) {
          ...
          log.eorder.error("XXXX FAILURE Admin updateStatusRequestDataChange by : " + req.dataToken.uid + ' fail:' + err)
          ...
          log.eorder.info("Admin updateStatusRequestDataChange by : " + req.dataToken.uid + ' success')
        }
      }
      )
    } else {
  ...
  getCondition: async (req, res) => {
    if (req.dataToken.type_id = 9) {
      dbConf.query(
        ...
        , (err, results) => {
          ...
          if (err) {
            ...
            log.eorder.error("XXXX FAILURE Admin getCondition by : " + req.dataToken.uid + ' fail:' + err)
            ...
            log.eorder.info("Admin getCondition by : " + req.dataToken.uid + ' success')
          }
        }
      )
    } else {
      ...
      log.eorder.warn("!!!_Unauthorized_!!! Admin Get getCondition by : " + req.dataToken.uid)
    }
  },
  getCompany: async (req, res) => {
    if (req.dataToken.type_id = 9) {
      ...
      dbConf.query(
        ...
        , (err, results) => {
          ...
          if (err) {
            ...
            log.eorder.error("XXXX FAILURE Admin getCompany by : " + req.dataToken.uid + ' fail:' + err)
            ...
            log.eorder.info("Admin getCompany by : " + req.dataToken.uid + ' success')
          }
        }
      )
    } else {
      ...
      log.eorder.warn("!!!_Unauthorized_!!! Admin Get getCompany by : " + req.dataToken.uid)
    }
  },
  getTOP: async (req, res) => {
    if (req.dataToken.type_id = 9) {
      ...
      dbConf.query(
        ...
        'SELECT 0 id , "" `DESC` union SELECT id, `DESC` FROM mst_top_foreign_code mtfc WHERE company_id = 100 AND active = 1;', (err, results) => {
          ...
          if (err) {
            ...
            log.eorder.error("XXXX FAILURE Admin getTOP by : " + req.dataToken.uid + ' fail:' + err)
            ...
            log.eorder.info("Admin getTOP by : " + req.dataToken.uid + ' success')
          }
      ...
      log.eorder.warn("!!!_Unauthorized_!!! Admin Get getTOP by : " + req.dataToken.uid)
    }
  },
    ...
    if (req.dataToken.type_id = 9) {
      ...
      dbConf.query(query, (err, results) => {
        ...
        if (err) {
          ...
          log.eorder.error("XXXX FAILURE Admin getAudit by : " + req.dataToken.uid + ' fail:' + err)
          ...
          log.eorder.info("Admin getAudit by : " + req.dataToken.uid + ' success')
        }
      ...
      log.eorder.warn("!!!_Unauthorized_!!! Admin Get getAudit by : " + req.dataToken.uid)
    }
  },
  ...
  sys_textCallBlockingDate: async (req, res) => {
    ...
    dbConf.query(query, (err, results) => {
      ...
      if (err) {
        ...
        res.status(500).send({ err });
        log.eorder.error("XXXX FAILURE Admin sys_textCallBlockingDate by : " + req.dataToken.uid + ' fail:' + err)

      } else {

        res.status(200).send({ results });
        log.eorder.info("Admin sys_textCallBlockingDate by : " + req.dataToken.uid + ' success')
      }
  ...
  getNextUserID: async (req, res) => {
    ...
    if (req.dataToken.type_id = 9) {
      try {
        ...
        dbConf.query(query, (err, results) => {
          if (err) {
            log.eorder.error("Error getNextUserID: " + err);
          ...
          log.eorder.info(`Next User ID for Company ${company_id} is ${nextId}`);
        });

      } catch (error) {
        log.eorder.error("Exception in getNextUserID: " + error);
  ...
  previewEOrderEmail: async (req, res) => {
    try {
      ...
      log.eorder.error("Error generating preview: " + err.message);
